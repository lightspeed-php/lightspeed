...
final class Command extends BaseCommand
{
    ...
    /**
     * Holds the custom TestRunner for Lightspeed
     *
     ...
     */
    public function __construct(TestSuite $testSuite, OutputInterface $output, LightspeedTestRunner $testRunner)
    {
    ...
    protected function createRunner(): TestRunner
    {
        ...
        $testRunner->setCustomRunner($this->testRunner);
